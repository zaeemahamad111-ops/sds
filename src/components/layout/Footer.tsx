  ...
  return (
    <footer className="bg-primary text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="col-span-1 md:col-span-1">
          <Link href="/" className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xl font-bold tracking-tight">SD&S EXPORT</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-white/60">
            <li className="flex items-center gap-3"><Mail size={16} className="text-secondary" /> info@sds-export.com</li>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 text-[10px] uppercase tracking-[0.2em] text-white/40 text-center md:text-left">
        <p>© 2025 SD&S EXPORT. ALL RIGHTS RESERVED.</p>
